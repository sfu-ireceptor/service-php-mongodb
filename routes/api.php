...
Route::any('/airr/v1/repertoire', 'SampleController@airr_repertoire');
Route::any('/airr/v1/repertoire/{repertoire_id}', 'SampleController@airr_repertoire_single');
Route::any('/airr/v1/rearrangement', 'SequenceController@airr_rearrangement');
Route::any('/airr/v1/rearrangement/{rearrangement_id}', 'SequenceController@airr_rearrangement_single');
